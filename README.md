...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/InfoSoftronix/k8s_metrics_server.git  and run the following command from
